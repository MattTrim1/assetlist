 ...
 */
class CRM_Assetlist_Upgrader_Base {

  /**
   * @var CRM_Assetlist_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Assetlist_Upgrader(
        'assetlist',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Assetlist_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Assetlist_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
